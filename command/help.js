...
╟│◎ Terbit : *01-09-1999*
╟│◈ ━━━━━━━ ◆ ━━━━━━━ ◈
╟│${ucapanWaktu} ${pushname !== undefined 
╟│pushname : 'Kak'}
╟│◈ ━━━━━━━ ◆ ━━━━━━━ ◈
╟│     ╔════•| ⎋ |•════╗
╟│       Ini Adalah Bot PC 
...
╟│pushname : '-'}
╟᠂᠂⎆ Status : ${isCreator ? 'Owner' : isPremium?
╟│ 'Premium' : 'Free'}
╟᠂᠂⎆ Limit : ${isCreator ? 'Unlimited' : 
╟│isPremium ? 'Unlimited' : getLimit(sender, 
╟│limitCount, limit)}
╟᠂᠂⎆ Limit Game : ${isCreator ? 'Unlimited' : 
╟│cekGLimit(sender, gcount, glimit)}
╟᠂᠂⎆ Balance : ${toCommas(getBalance(sender, 
╟│ balance))}
╟᠂᠂⎆ Role : ${role}
╟│ 
╟│
